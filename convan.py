...
parser.add_argument("-n", "--name", help="Specify the name of the subdirectory and audio files", default=None)
parser.add_argument("-o", "--outputdir", help="Specify an output directory", default=None)
parser.add_argument("-s", "--nosubdir", help="Disables the creation of a subdirectory; incompatible with -m", action='store_true')
parser.add_argument("-k", "--keeptmp", help="Keep all temporary files after conversion", action='store_true')
parser.add_argument("-m", "--moveog", help="Moves the original file into the subdirectory; incompatible with -s", action='store_true')
parser.add_argument("-w", "--wavonly", help="Converts any given compatible file to a WAV file only", action='store_true')
parser.add_argument("--del_og", help="Deletes the original file after conversion", action='store_true')
